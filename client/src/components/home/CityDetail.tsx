...
import FlighIcon from "@/assets/icons/airplanemode_active.svg?react";
    ...
    <div className="w-full flex flex-col">
      <div className="mb-18 flex">
        <div className="flex-1 flex flex-col mr-17">
          <div className="mb-18">
            <h3 className="text-20 text-gray300 mb-10">{city.nameEn.toLocaleUpperCase()}</h3>
            <h2 className="text-30 font-bold">
              {city.country.name} {city.name}
            </h2>
          </div>
          <p className="text-14 leading-[160%] -tracking-[0.08px] mb-18">{city.description}</p>
          <div className="flex gap-x-26 mb-16">
            <div className="flex flex-col">
              <div className="flex text-15 tracking-[0.15px] font-semibold mb-16">
                <FlighIcon className="mr-8" />
                <span>항공</span>
              </div>
            ...
            <div className="flex flex-col">
              ...
              <p>{city.timezoneOffset === 0 ? "없음" : `${city.timezoneOffset}시간`}</p>
            </div>
          </div>
        </div>
