    ...
    <div className="text-left flex flex-col gap-y-18 w-[368px]">
      <p className="text-17 tracking-[0.17px] font-medium flex items-center gap-x-16">
        ...
        <span className="text-[#5a88ff]">
          총 {formatMintesToTime(totalTime)}
        </span>
      ...
      {!hidden && (
        <>
          <p className="text-15 leading-[1.7] -tracking-[0.09px]">
            입력하신 여행 기간의 시차를 고려한 현지 여행 기간이 맞는지 확인해
            주시고 각 날짜의 일정 시작시간과 종료시간을 현지 시간기준으로
            설정해주세요. 기본 설정시간은 오전 10시 ~ 오후 10시 총 12시간입니다.
          </p>
          <div>
                  ...
                  <tr key={idx}>
                    ...
                    <td className="py-10">
                      <input
                        ...
                        onChange={(e) =>
                          setDailyTimes(idx, e.currentTarget.value, "startTime")
                        }
                      />
                    </td>
                    <td className="py-10">
                      <input
                        ...
                        onChange={(e) =>
                          setDailyTimes(idx, e.currentTarget.value, "endTime")
                        }
                      />
                    </td>
                  </tr>
...
const formatMintesToTime = (minutes: number) => {
